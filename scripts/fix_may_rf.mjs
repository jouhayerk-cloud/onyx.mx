...
async function fixMayRF() {
    await supabase.from('logistics').update({ status: 'Deployed' }).eq('id', '93ac3c0a-9411-4573-9df9-19c459d1def0');
    console.log("Fixed May RF crate by setting to Deployed.");
}
fixMayRF();
