...
async function checkMissing() {
    const ids = ['0e0f5592-61d4-4c21-8f80-99f42aa295bb', '33e59e96-ccd7-42ab-8c80-949b86c12859'];
    const { data: crates } = await supabase.from('logistics').select('id, description, status, date, updated_at').in('id', ids);
