import{j as e}from"./vendor-animation-CsQXa6Ud.js";import{bv as S,bw as R,ab as A,bx as C,i as z,by as T,bz as D,bA as P,D as M,r as L,aV as E,O}from"./main-C2GMhjN4.js";import{T as l}from"./themes-assets-iyrvH4b1.js";import{f as o}from"./vendor-react-X1ncQZTb.js";import{X as F,Q as U,am as $,bi as B,bj as H,O as V,aR as x,a6 as q,as as G,be as W}from"./vendor-icons-BaSPY7m2.js";import"./vendor-pdf-9nCjTQbs.js";import"./vendor-db-CJUS5vCL.js";import"./vendor-supabase-CHLpTVyu.js";import"./vendor-excel-BQc79nsb.js";const Q=`# Changelog
# 
## [1.80.0] - 2026-04-24
### Added
...
---
`,X=["nacar","aqua"],_=[{name:"talan",swatch:l.talan.swatch},{name:"fluorite",swatch:l.fluorite.swatch},{name:"nacar",swatch:l.nacar.swatch},{name:"aqua",swatch:l.aqua.swatch}],oe=()=>{const[f,b]=o(S),[m,y]=o(R),[g,v]=o(A),[r,w]=o(C),[p]=o(z),[d]=o(T),{goOffline:k,goOnline:j}=D(),N=P(),{t:J}=M();if(!f)return null;const t=X.includes(g),h=()=>b(!1),I=a=>{if(a.trim().length===0)return e.jsxs("div",{className:`flex flex-col items-center justify-center py-20 gap-4 ${t?"text-black/30":"text-white/30"}`,children:[e.jsx(G,{size:40,strokeWidth:1}),e.jsx("p",{className:"text-xs font-black uppercase tracking-[0.2em]",children:"Documentation Offline"})]});const u=a.replace(/<!--[\s\S]*?-->/g,"").trim().split(`
