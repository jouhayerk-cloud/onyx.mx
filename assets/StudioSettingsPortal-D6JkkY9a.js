import{j as e}from"./vendor-animation-BnLeEdnc.js";import{bF as P,bG as L,ah as M,bH as E,bI as F,i as O,bJ as U,bK as $,bL as B,G as H,r as V,b3 as q,O as G,bM as x}from"./main-B-3PC41C.js";import{T as d}from"./themes-assets-iyrvH4b1.js";import{f as s}from"./vendor-react-BCVEEGVz.js";import{B as W,v as Q,U as X,X as _,a1 as K,as as Y,bp as J,bq as Z,a0 as ee,aZ as w,s as te,ay as ae,aU as ie}from"./vendor-icons-BIBlPADK.js";import"./vendor-pdf-qMVF-_XN.js";import"./vendor-db-BbqE7tWj.js";import"./vendor-supabase-CHLpTVyu.js";import"./vendor-excel-BlXdyc7A.js";const ne=`# Changelog\r
# \r
## [1.80.0] - 2026-04-24\r
### Added\r
...
\r
---\r
`,re=["nacar","aqua"],p={rock:{label:"ROCK",icon:X,tint:"text-white/20 hover:bg-white/10",chip:null},paper:{label:"PAPER",icon:Q,tint:"text-blue-500 hover:bg-blue-500/10",chip:"bg-blue-500 text-white"},slab:{label:"SLAB",icon:W,tint:"text-teal-400 hover:bg-teal-400/10",chip:"bg-teal-400 text-black"}},se=[{name:"talan",swatch:d.talan.swatch},{name:"fluorite",swatch:d.fluorite.swatch},{name:"nacar",swatch:d.nacar.swatch},{name:"aqua",swatch:d.aqua.swatch}],fe=()=>{const[k,j]=s(P),[g,N]=s(L),[h,I]=s(M),[f,S]=s(E),[l,A]=s(F),[b]=s(O),[c]=s(U),{goOffline:C,goOnline:R}=$(),T=B(),{t:oe}=H();if(!k)return null;const t=re.includes(h),o=p[f]??p.rock,z=o.icon,u=x[(x.indexOf(f)+1)%x.length],y=()=>j(!1),D=a=>{if(a.trim().length===0)return e.jsxs("div",{className:`flex flex-col items-center justify-center py-20 gap-4 ${t?"text-black/30":"text-white/30"}`,children:[e.jsx(ae,{size:40,strokeWidth:1}),e.jsx("p",{className:"text-xs font-black uppercase tracking-[0.2em]",children:"Documentation Offline"})]});const v=a.replace(/<!--[\s\S]*?-->/g,"").trim().split(`
`),n=[];return v.forEach((i,r)=>{if(!i.trim()){n.push(e.jsx("div",{className:"h-4"},r));return}if(i.startsWith("### "))n.push(e.jsxs("h3",{className:"text-blue-500 font-black mt-8 mb-4 text-[10px] tracking-[0.4em] uppercase flex items-center gap-3",children:[e.jsx(ie,{size:12})," ",i.replace("### ","")]},r));else if(i.startsWith("## "))n.push(e.jsx("h2",{className:`font-black mt-12 mb-6 text-2xl tracking-tighter ${t?"text-black":"text-white"}`,children:i.replace("## ","")},r));else if(i.startsWith("- **")){const m=i.split("**");n.push(e.jsxs("div",{className:"flex gap-4 mb-4 select-text",children:[e.jsx("span",{className:"text-blue-500/50 mt-1.5 shrink-0",children:"•"}),e.jsxs("p",{className:`text-[13px] leading-relaxed tracking-tight ${t?"text-black/80":"text-white/80"}`,children:[e.jsx("strong",{className:`font-black uppercase tracking-wider mr-2 ${t?"text-black":"text-white"}`,children:m[1]||""}),e.jsx("span",{className:t?"text-black/60":"text-white/60",children:m.slice(2).join("")})]})]},r))}else i.startsWith("- ")?n.push(e.jsxs("div",{className:"flex gap-4 mb-4 select-text",children:[e.jsx("span",{className:`mt-1.5 shrink-0 ${t?"text-black/30":"text-white/30"}`,children:"•"}),e.jsx("p",{className:`text-[13px] leading-relaxed tracking-tight ${t?"text-black/60":"text-white/60"}`,children:i.replace("- ","")})]},r)):i.includes("---")?n.push(e.jsx("hr",{className:`my-12 ${t?"border-black/10":"border-white/10"}`},r)):i.startsWith("# ")||n.push(e.jsx("p",{className:`text-[12px] leading-relaxed mb-4 select-text ${t?"text-black/50":"text-white/50"}`,children:i.trim()},r))}),n};return V.createPortal(e.jsx(e.Fragment,{children:e.jsxs("div",{className:"fixed inset-0 z-[5000] flex items-center justify-center animate-in fade-in duration-700 overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/20 backdrop-blur-[80px]",onClick:y}),e.jsxs("div",{className:"relative w-full h-[100dvh] md:w-[95vw] md:h-[95vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-700",children:[e.jsxs("div",{className:"flex items-center justify-between p-6 md:p-12 z-20",children:[e.jsxs("div",{className:"flex items-center gap-6 md:gap-8",children:[e.jsx("div",{className:"relative cursor-pointer group",onClick:()=>N(g==="settings"?"about":"settings"),children:e.jsx(q,{className:`w-8 h-8 md:w-10 md:h-10 transition-all duration-700 group-hover:rotate-180 ${t?"text-black":"text-white"}`})}),e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-1",children:[e.jsx("h1",{className:`text-lg md:text-3xl font-black uppercase tracking-[0.4em] leading-none ${t?"text-black":"text-white"}`,children:"Onyx.mx"}),e.jsx("span",{className:`h-[1px] w-8 ${t?"bg-black/40":"bg-white/40"}`}),e.jsx("span",{className:"text-[9px] font-black text-blue-500 tracking-[0.3em] uppercase",children:"Settings"})]}),e.jsxs("span",{className:`text-[8px] font-black uppercase tracking-[0.5em] ${t?"text-black/40":"text-white/40"}`,children:["V","1.81.29"]})]})]}),e.jsx("button",{onClick:y,className:`p-2 md:p-4 transition-all duration-150 transform hover:rotate-90 active:scale-75 ${t?"text-black/30 hover:text-black":"text-white/30 hover:text-white"}`,children:e.jsx(_,{className:"w-6 h-6 md:w-8 md:h-8",strokeWidth:1.5})})]}),e.jsxs("div",{className:"flex-1 flex flex-col md:flex-row overflow-hidden px-8 md:px-12 pb-4",children:[g==="settings"&&e.jsx("div",{className:"hidden xl:flex w-1/4 flex-col justify-center items-start pr-16 animate-in slide-in-from-left-12 duration-700",children:e.jsxs("div",{className:"relative group",children:[e.jsx(G,{className:`w-56 h-56 transition-all duration-700 group-hover:scale-110 ${t?"text-black/15 group-hover:text-black/30":"text-white/15 group-hover:text-white/30"}`}),e.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,var(--main-color)_0%,transparent_70%)] opacity-30 blur-3xl animate-pulse"})]})}),e.jsx("div",{className:"flex-1 overflow-y-auto custom-scrollbar pr-4 select-none",children:g==="settings"?e.jsxs("div",{className:"space-y-8 md:space-y-16 pb-20",children:[e.jsxs("div",{className:"p-4 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 animate-in slide-in-from-top-4 duration-700",children:[e.jsxs("div",{className:"flex items-center gap-6 md:gap-8 w-full md:w-auto",children:[e.jsx(K,{size:32,strokeWidth:2,className:"text-purple-500"}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`text-[8px] md:text-[9px] font-black uppercase tracking-[0.6em] mb-1 ${t?"text-black":"text-white"}`,children:"Operator"}),e.jsxs("div",{className:"flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4",children:[e.jsx("span",{className:`text-xl md:text-2xl font-black uppercase tracking-widest leading-none ${t?"text-black":"text-white"}`,children:b?.name||"ROOT"}),e.jsx("span",{className:"text-[10px] md:text-[11px] font-black text-blue-500 lowercase tracking-[0.2em] opacity-60",children:b?.email?.toLowerCase()})]})]})]}),e.jsxs("div",{className:"flex items-center gap-4 md:gap-8 w-full md:w-auto justify-end border-t md:border-t-0 pt-6 md:pt-0 border-white/5",children:[e.jsxs("button",{onClick:()=>S(u),className:`flex items-center gap-3 p-3 rounded-xl transition-all duration-150 ${o.tint}`,title:`${o.label} STYLE — CLICK FOR ${p[u].label}`,"aria-label":`Interface style: ${o.label}. Activate to switch to ${p[u].label}.`,children:[e.jsx(z,{size:20}),e.jsx("span",{className:`text-[10px] font-black px-1.5 py-0.5 rounded transition-all duration-150 ${o.chip??(t?"bg-black/10 text-black":"bg-white/10 text-white")} uppercase tracking-wider`,children:o.label})]}),e.jsxs("button",{onClick:()=>A(!l),className:`flex items-center gap-3 p-3 rounded-xl transition-all duration-150 ${l?"text-yellow-500 hover:bg-yellow-500/10":"text-white/20 hover:bg-white/10"}`,title:l?"MAX PERFORMANCE":"STANDARD PERFORMANCE",children:[e.jsx(Y,{size:20}),e.jsx("span",{className:`text-[10px] font-black px-1.5 py-0.5 rounded transition-all duration-150 ${l?"bg-yellow-500 text-black":t?"bg-black/10 text-black":"bg-white/10 text-white"}`,children:l?"MAX":"STD"})]}),e.jsx("button",{onClick:c?R:C,className:`p-3 rounded-xl transition-all duration-150 ${c?"text-green-500 hover:bg-green-500/10":"text-amber-500 hover:bg-amber-500/10"}`,title:c?"GO ONLINE":"GO OFFLINE",children:c?e.jsx(J,{size:20}):e.jsx(Z,{size:20})}),e.jsx("button",{onClick:T,className:"p-3 rounded-xl text-red-500 hover:bg-red-500/10 transition-all duration-150",title:"TERMINATE SESSION",children:e.jsx(ee,{size:20})})]})]}),e.jsxs("div",{className:"grid grid-cols-1 xl:grid-cols-12 gap-12 md:gap-16",children:[e.jsxs("div",{className:"xl:col-span-4",children:[e.jsxs("div",{className:"flex items-center gap-3 pb-4 mb-8",children:[e.jsx(w,{size:14,className:"text-blue-500"}),e.jsx("h3",{className:`text-sm font-black uppercase tracking-[0.4em] ${t?"text-black":"text-white"}`,children:"Themes"})]}),e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-2 gap-4 md:gap-6",children:se.map(a=>{const n=d[a.name]?.hexInfo,i=h===a.name;return e.jsxs("div",{onClick:()=>I(a.name),className:`group relative aspect-square transition-all duration-150 cursor-pointer ${i?"opacity-100":"opacity-20 hover:opacity-100 grayscale hover:grayscale-0"}`,children:[i&&e.jsx("div",{className:"absolute -inset-3 rounded-2xl bg-blue-500/5 animate-pulse"}),e.jsx("div",{className:`w-full h-full rounded-2xl bg-cover bg-center transition-all duration-150 ${i?"scale-100 rotate-0":"scale-90 -rotate-2 group-hover:rotate-0 group-hover:scale-100"}`,style:{backgroundImage:`url(${a.swatch})`}}),e.jsxs("div",{className:"absolute inset-x-0 -bottom-8 flex flex-col items-center gap-1.5 transition-all duration-150",children:[e.jsx("span",{className:`text-[12px] md:text-[14px] font-black uppercase tracking-[0.6em] transition-colors duration-150 ${i?t?"text-black":"text-white":t?"text-black/30 group-hover:text-black":"text-white/30 group-hover:text-white"}`,children:a.name}),e.jsx("div",{className:"flex gap-1",children:n?.accents.map((r,m)=>e.jsx("div",{className:"w-2 h-2 rounded-full",style:{backgroundColor:r}},m))})]})]},a.name)})})]}),e.jsxs("div",{className:"xl:col-span-8 space-y-8",children:[e.jsxs("div",{className:"flex items-center gap-3 pb-4",children:[e.jsx(w,{size:14,className:"text-cyan-500"}),e.jsx("h3",{className:`text-sm font-black uppercase tracking-[0.4em] ${t?"text-black":"text-white"}`,children:"Colors"})]}),e.jsx("div",{className:"grid grid-cols-4 sm:grid-cols-6 gap-3 md:gap-4",children:[{label:"Surface",key:"--app-bg-solid"},{label:"Neural",key:"--main-color"},{label:"Static",key:"--secondary-color"},{label:"Text P",key:"--text-color-primary"},{label:"Text S",key:"--text-color-secondary"},{label:"Boundary",key:"--border-color"},{label:"Input",key:"--input-color"},{label:"Sidebar",key:"--sidebar-bg"},{label:"Portal",key:"--app-bg"},{label:"Glass",key:"--glass-bg"},{label:"Base",key:"--bg-color"},{label:"Accent",key:"--accent-color"}].map(a=>e.jsxs("div",{className:"group flex flex-col gap-0",children:[e.jsx("span",{className:`text-[8px] font-mono uppercase tracking-tighter truncate mb-1 transition-colors duration-150 ${t?"text-black/50 group-hover:text-black":"text-white/50 group-hover:text-white"}`,children:getComputedStyle(document.documentElement).getPropertyValue(a.key).trim()||"#---"}),e.jsx("div",{className:"w-full aspect-square rounded-lg transition-all duration-150 group-hover:scale-105 group-hover:shadow-[0_0_20px_rgba(0,0,0,0.2)]",style:{backgroundColor:`var(${a.key})`}}),e.jsx("span",{className:`text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] truncate mt-2 transition-colors duration-150 ${t?"text-black":"text-white"}`,children:a.label})]},`${a.key}-${h}`))})]})]})]}):e.jsxs("div",{className:"max-w-4xl mx-auto py-12 animate-in slide-in-from-bottom-12 duration-700 select-text",children:[e.jsxs("div",{className:`flex items-center gap-6 mb-16 ${t?"opacity-40":"opacity-30"}`,children:[e.jsx("h2",{className:`text-[10px] font-black uppercase tracking-[1em] ${t?"text-black":"text-white"}`,children:"System Logs"}),e.jsx("div",{className:`h-[1px] flex-1 ${t?"bg-black/20":"bg-white/20"}`})]}),D(ne)]})})]}),e.jsxs("div",{className:"mt-auto px-6 py-6 md:px-12 md:pb-16 md:pt-12 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20 animate-in slide-in-from-bottom-8 duration-700 shrink-0",children:[e.jsxs("div",{className:"flex items-center justify-between w-full md:w-auto md:gap-24",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:"Latency"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter ${t?"text-black":"text-white"}`,children:"14MS"}),e.jsx("div",{className:"flex gap-1",children:[1,2,3,4,5].map(a=>e.jsx("div",{className:`w-1 h-4 md:h-6 ${a<4?"bg-blue-500":t?"bg-black/20":"bg-white/20"}`},a))})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:"Memory"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter ${t?"text-black":"text-white"}`,children:"1.2GB"}),e.jsx("div",{className:`w-12 md:w-20 h-2 rounded-full overflow-hidden ${t?"bg-black/15":"bg-white/15"}`,children:e.jsx("div",{className:"w-2/3 h-full bg-purple-500"})})]})]})]}),e.jsxs("div",{className:"flex items-center justify-between w-full md:w-auto md:gap-24 text-right",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:"Sync"}),e.jsxs("div",{className:"flex items-center gap-4 justify-end",children:[e.jsx("span",{className:"text-3xl md:text-5xl font-black text-green-500 tracking-tighter uppercase",children:"ACTIVE"}),e.jsx(te,{size:24,className:"text-green-500 animate-pulse"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:"Regional Hub"}),e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter uppercase ${t?"text-black":"text-white"}`,children:"MX-NORTH"})]})]})]})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                ...
                `}})]})}),document.body)};export{fe as StudioSettingsPortal};
