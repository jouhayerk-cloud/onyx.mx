import{j as e}from"./vendor-animation-C_IUUNV4.js";import{bu as S,bv as C,aa as R,bw as A,i as z,bx as T,by as D,bz as P,C as M,r as L,aU as E,O as F}from"./main-BrPZAsrS.js";import{T as l}from"./themes-assets-iyrvH4b1.js";import{f as o}from"./vendor-react-C0lCFRHy.js";import{X as O,U,am as $,bi as B,bj as H,Q as V,aR as x,a7 as q,as as G,be as W}from"./vendor-icons-DMMLUlcP.js";import"./vendor-pdf-DA7OMzUT.js";import"./vendor-db-CJUS5vCL.js";import"./vendor-supabase-CHLpTVyu.js";import"./vendor-excel-D91t5TVv.js";const Q=`# Changelog
# 
## [1.80.0] - 2026-04-24
### Added
...
---
`,X=["nacar","aqua"],_=[{name:"talan",swatch:l.talan.swatch},{name:"fluorite",swatch:l.fluorite.swatch},{name:"nacar",swatch:l.nacar.swatch},{name:"aqua",swatch:l.aqua.swatch}],oe=()=>{const[f,b]=o(S),[m,y]=o(C),[g,v]=o(R),[r,w]=o(A),[p]=o(z),[d]=o(T),{goOffline:k,goOnline:j}=D(),N=P(),{t:J}=M();if(!f)return null;const t=X.includes(g),h=()=>b(!1),I=a=>{if(a.trim().length===0)return e.jsxs("div",{className:`flex flex-col items-center justify-center py-20 gap-4 ${t?"text-black/30":"text-white/30"}`,children:[e.jsx(G,{size:40,strokeWidth:1}),e.jsx("p",{className:"text-xs font-black uppercase tracking-[0.2em]",children:"Documentation Offline"})]});const u=a.replace(/<!--[\s\S]*?-->/g,"").trim().split(`
