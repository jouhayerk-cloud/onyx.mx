import{j as e}from"./vendor-animation-BnLeEdnc.js";import{bV as M,bW as O,au as F,bX as $,bY as U,j as B,bZ as H,bR as V,b_ as q,b$ as G,r as W,bh as Q,t as a,O as X,c0 as b}from"./main-CPWFhZAs.js";import{T as k}from"./themes-assets-DWSHTDDO.js";import{f as o}from"./vendor-react-BCVEEGVz.js";import{B as _,x as K,X as Y,a3 as Z,a$ as J,az as ee,bt as te,bu as ae,a2 as ie,am as N,r as ne,aF as re,a_ as se}from"./vendor-icons-BXMockRn.js";import"./vendor-pdf-qMVF-_XN.js";import"./vendor-db-BbqE7tWj.js";import"./vendor-supabase-CHLpTVyu.js";import"./vendor-excel-BlXdyc7A.js";const oe=`# Changelog\r
# \r
## [1.80.0] - 2026-04-24\r
### Added\r
...
\r
---\r
`,le=["aqua"],h={rock:{label:"ROCK",icon:K},slab:{label:"SLAB",icon:_}},de=[{name:"talan",swatch:k.talan.swatch},{name:"aqua",swatch:k.aqua.swatch}],ye=()=>{const[j,I]=o(M),[u,S]=o(O),[x,A]=o(F),[g,C]=o($),[d,R]=o(U),[y]=o(B),[c]=o(H),[r,T]=o(V),{goOffline:z,goOnline:L}=q(),D=G();if(!j)return null;const t=le.includes(x),p=h[g]??h.rock,P=p.icon,f=b[(b.indexOf(g)+1)%b.length],v=()=>I(!1),E=i=>{if(i.trim().length===0)return e.jsxs("div",{className:`flex flex-col items-center justify-center py-20 gap-4 ${t?"text-black/30":"text-white/30"}`,children:[e.jsx(re,{size:40,strokeWidth:1}),e.jsx("p",{className:"text-xs font-black uppercase tracking-[0.2em]",children:a("Documentation Offline")})]});const m=i.replace(/<!--[\s\S]*?-->/g,"").trim().split(`
`),s=[];return m.forEach((n,l)=>{if(!n.trim()){s.push(e.jsx("div",{className:"h-4"},l));return}if(n.startsWith("### "))s.push(e.jsxs("h3",{className:"text-blue-500 font-black mt-8 mb-4 text-[10px] tracking-[0.4em] uppercase flex items-center gap-3",children:[e.jsx(se,{size:12})," ",n.replace("### ","")]},l));else if(n.startsWith("## "))s.push(e.jsx("h2",{className:`font-black mt-12 mb-6 text-2xl tracking-tighter ${t?"text-black":"text-white"}`,children:n.replace("## ","")},l));else if(n.startsWith("- **")){const w=n.split("**");s.push(e.jsxs("div",{className:"flex gap-4 mb-4 select-text",children:[e.jsx("span",{className:"text-blue-500/50 mt-1.5 shrink-0",children:"•"}),e.jsxs("p",{className:`text-[13px] leading-relaxed tracking-tight ${t?"text-black/80":"text-white/80"}`,children:[e.jsx("strong",{className:`font-black uppercase tracking-wider mr-2 ${t?"text-black":"text-white"}`,children:w[1]||""}),e.jsx("span",{className:t?"text-black/60":"text-white/60",children:w.slice(2).join("")})]})]},l))}else n.startsWith("- ")?s.push(e.jsxs("div",{className:"flex gap-4 mb-4 select-text",children:[e.jsx("span",{className:`mt-1.5 shrink-0 ${t?"text-black/30":"text-white/30"}`,children:"•"}),e.jsx("p",{className:`text-[13px] leading-relaxed tracking-tight ${t?"text-black/60":"text-white/60"}`,children:n.replace("- ","")})]},l)):n.includes("---")?s.push(e.jsx("hr",{className:`my-12 ${t?"border-black/10":"border-white/10"}`},l)):n.startsWith("# ")||s.push(e.jsx("p",{className:`text-[12px] leading-relaxed mb-4 select-text ${t?"text-black/50":"text-white/50"}`,children:n.trim()},l))}),s};return W.createPortal(e.jsx(e.Fragment,{children:e.jsxs("div",{className:"fixed inset-0 z-[5000] flex items-center justify-center animate-in fade-in duration-700 overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/20 backdrop-blur-[80px]",onClick:v}),e.jsxs("div",{className:"relative w-full h-[100dvh] md:w-[95vw] md:h-[95vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-700",children:[e.jsxs("div",{className:"flex items-center justify-between p-6 md:p-12 z-20",children:[e.jsxs("div",{className:"flex items-center gap-6 md:gap-8",children:[e.jsx("div",{className:"relative cursor-pointer group",onClick:()=>S(u==="settings"?"about":"settings"),children:e.jsx(Q,{className:`w-8 h-8 md:w-10 md:h-10 transition-all duration-700 group-hover:rotate-180 ${t?"text-black":"text-white"}`})}),e.jsxs("div",{className:"flex flex-col",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-1",children:[e.jsx("h1",{className:`text-lg md:text-3xl font-black uppercase tracking-[0.4em] leading-none ${t?"text-black":"text-white"}`,children:"Onyx.mx"}),e.jsx("span",{className:`h-[1px] w-8 ${t?"bg-black/40":"bg-white/40"}`}),e.jsx("span",{className:"text-[9px] font-black text-blue-500 tracking-[0.3em] uppercase",children:a("Settings")})]}),e.jsxs("span",{className:`text-[8px] font-black uppercase tracking-[0.5em] ${t?"text-black/40":"text-white/40"}`,children:["V","1.81.29"]})]})]}),e.jsx("button",{onClick:v,className:`p-2 md:p-4 transition-all duration-150 transform hover:rotate-90 active:scale-75 ${t?"text-black/30 hover:text-black":"text-white/30 hover:text-white"}`,children:e.jsx(Y,{className:"w-6 h-6 md:w-8 md:h-8",strokeWidth:1.5})})]}),e.jsxs("div",{className:"flex-1 flex flex-col md:flex-row overflow-hidden px-8 md:px-12 pb-4",children:[u==="settings"&&e.jsx("div",{className:"hidden xl:flex w-1/4 flex-col justify-center items-start pr-16 animate-in slide-in-from-left-12 duration-700",children:e.jsxs("div",{className:"relative group",children:[e.jsx(X,{className:`w-56 h-56 transition-all duration-700 group-hover:scale-110 ${t?"text-black/15 group-hover:text-black/30":"text-white/15 group-hover:text-white/30"}`}),e.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,var(--main-color)_0%,transparent_70%)] opacity-30 blur-3xl animate-pulse"})]})}),e.jsx("div",{className:"flex-1 overflow-y-auto custom-scrollbar pr-4 select-none",children:u==="settings"?e.jsxs("div",{className:"space-y-8 md:space-y-16 pb-20",children:[e.jsxs("div",{className:"p-4 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 animate-in slide-in-from-top-4 duration-700",children:[e.jsxs("div",{className:"flex items-center gap-6 md:gap-8 w-full md:w-auto",children:[e.jsx(Z,{size:32,strokeWidth:2,className:"text-purple-500"}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`text-[8px] md:text-[9px] font-black uppercase tracking-[0.6em] mb-1 ${t?"text-black":"text-white"}`,children:a("Operator")}),e.jsxs("div",{className:"flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4",children:[e.jsx("span",{className:`text-xl md:text-2xl font-black uppercase tracking-widest leading-none ${t?"text-black":"text-white"}`,children:y?.name||a("ROOT")}),e.jsx("span",{className:"text-[10px] md:text-[11px] font-black text-blue-500 lowercase tracking-[0.2em] opacity-60",children:y?.email?.toLowerCase()})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2.5 md:gap-3 w-full md:w-auto justify-end border-t md:border-t-0 pt-6 md:pt-0 border-white/5",children:[e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-1.5",children:[e.jsx("button",{type:"button",onClick:()=>T(r==="es"?"en":"es"),"aria-pressed":r==="es","aria-label":`Language: ${r==="es"?"Espanol":"English"}. Activate to switch to ${r==="es"?"English":"Espanol"}.`,title:r==="es"?"ESPANOL — CLICK FOR ENGLISH":"ENGLISH — CLICK FOR ESPANOL",className:"tool-btn flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-xl transition-all duration-150 hover:bg-white/10",children:e.jsx(J,{size:26,className:r==="es"?"text-(--main-color)":t?"text-black/40":"text-white/40"})}),e.jsx("span",{className:`tool-label text-[8px] font-black uppercase tracking-[0.16em] leading-none ${r==="es"?"text-(--main-color)":t?"text-black/40":"text-white/40"}`,children:r==="es"?a("ES"):a("EN")})]}),e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-1.5",children:[e.jsx("button",{type:"button",onClick:()=>C(f),"aria-pressed":g==="slab","aria-label":`Interface style: ${p.label}. Activate to switch to ${h[f].label}.`,title:`${p.label} STYLE — CLICK FOR ${h[f].label}`,className:"tool-btn flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-xl transition-all duration-150 hover:bg-white/10",children:e.jsx(P,{size:26,className:g==="slab"?"text-(--main-color)":t?"text-black/40":"text-white/40"})}),e.jsx("span",{className:`tool-label text-[8px] font-black uppercase tracking-[0.16em] leading-none ${g==="slab"?"text-(--main-color)":t?"text-black/40":"text-white/40"}`,children:p.label})]}),e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-1.5",children:[e.jsx("button",{type:"button",onClick:()=>R(!d),"aria-pressed":d,title:d?"MAX PERFORMANCE — click for standard":"STANDARD PERFORMANCE — click for max",className:"tool-btn flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-xl transition-all duration-150 hover:bg-white/10",children:e.jsx(ee,{size:26,className:d?"text-yellow-500":t?"text-black/40":"text-white/40"})}),e.jsx("span",{className:`tool-label text-[8px] font-black uppercase tracking-[0.16em] leading-none ${d?"text-yellow-500":t?"text-black/40":"text-white/40"}`,children:d?a("MAX"):a("STD")})]}),e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-1.5",children:[e.jsx("button",{type:"button",onClick:c?L:z,"aria-pressed":c,title:c?"GO ONLINE":"GO OFFLINE",className:"tool-btn flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-xl transition-all duration-150 hover:bg-white/10",children:c?e.jsx(te,{size:26,className:"text-green-500"}):e.jsx(ae,{size:26,className:"text-amber-500"})}),e.jsx("span",{className:`tool-label text-[8px] font-black uppercase tracking-[0.16em] leading-none ${c?"text-green-500":"text-amber-500"}`,children:c?a("OFFLINE"):"ONLINE"})]}),e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-1.5",children:[e.jsx("button",{type:"button",onClick:D,title:a("TERMINATE SESSION"),className:"tool-btn flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-xl transition-all duration-150 hover:bg-red-500/10",children:e.jsx(ie,{size:26,className:"text-red-500"})}),e.jsx("span",{className:"tool-label text-[8px] font-black uppercase tracking-[0.16em] leading-none text-red-500",children:a("EXIT")})]})]})]}),e.jsxs("div",{className:"flex flex-col md:flex-row md:items-start gap-10 md:gap-16",children:[e.jsxs("div",{className:"shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-3 pb-4 mb-4",children:[e.jsx(N,{size:14,className:"text-blue-500"}),e.jsx("h3",{className:`text-sm font-black uppercase tracking-[0.4em] ${t?"text-black":"text-white"}`,children:a("Theme")})]}),e.jsx("div",{className:"flex items-center gap-5 md:gap-6",children:de.map(i=>{const m=x===i.name;return e.jsxs("div",{className:"tool-cell flex flex-col items-center gap-2",children:[e.jsx("button",{type:"button",onClick:()=>A(i.name),"aria-pressed":m,"aria-label":`Theme: ${i.name}`,title:i.name.toUpperCase(),className:`tool-btn relative w-12 h-12 md:w-14 md:h-14 rounded-2xl overflow-hidden p-0 transition-all duration-150 ${m?"ring-2 ring-(--main-color)":t?"ring-1 ring-black/10 hover:ring-black/20":"ring-1 ring-white/10 hover:ring-white/20"}`,children:e.jsx("span",{className:"absolute inset-0 bg-cover bg-center transition-opacity duration-150",style:{backgroundImage:`url(${i.swatch})`,opacity:m?1:.4}})}),e.jsx("span",{className:`tool-label text-[9px] font-black uppercase tracking-[0.25em] transition-colors duration-150 ${m?"text-(--main-color)":t?"text-black/40":"text-white/40"}`,children:i.name})]},i.name)})})]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-3 pb-4 mb-4",children:[e.jsx(N,{size:14,className:"text-cyan-500"}),e.jsx("h3",{className:`text-sm font-black uppercase tracking-[0.4em] ${t?"text-black":"text-white"}`,children:a("Colors")})]}),e.jsx("div",{className:"flex flex-wrap gap-4 md:gap-5",children:[{label:a("Surface"),key:"--app-bg-solid"},{label:a("Neural"),key:"--main-color"},{label:a("Static"),key:"--secondary-color"},{label:a("Text P"),key:"--text-color-primary"},{label:a("Text S"),key:"--text-color-secondary"},{label:a("Boundary"),key:"--border-color"},{label:a("Input"),key:"--input-color"},{label:a("Sidebar"),key:"--sidebar-bg"},{label:a("Portal"),key:"--app-bg"},{label:a("Glass"),key:"--glass-bg"},{label:a("Base"),key:"--bg-color"},{label:a("Accent"),key:"--accent-color"}].map(i=>e.jsxs("div",{className:"flex flex-col items-center gap-1.5 w-12",children:[e.jsx("div",{className:`w-8 h-8 md:w-9 md:h-9 rounded-lg transition-transform duration-150 hover:scale-110 ${t?"ring-1 ring-black/10":"ring-1 ring-white/10"}`,style:{backgroundColor:`var(${i.key})`},title:`${i.label}: ${getComputedStyle(document.documentElement).getPropertyValue(i.key).trim()||"#---"}`}),e.jsx("span",{className:`text-[8px] font-black uppercase tracking-[0.1em] truncate w-full text-center ${t?"text-black/50":"text-white/50"}`,children:i.label})]},`${i.key}-${x}`))})]})]})]}):e.jsxs("div",{className:"max-w-4xl mx-auto py-12 animate-in slide-in-from-bottom-12 duration-700 select-text",children:[e.jsxs("div",{className:`flex items-center gap-6 mb-16 ${t?"opacity-40":"opacity-30"}`,children:[e.jsx("h2",{className:`text-[10px] font-black uppercase tracking-[1em] ${t?"text-black":"text-white"}`,children:a("System Logs")}),e.jsx("div",{className:`h-[1px] flex-1 ${t?"bg-black/20":"bg-white/20"}`})]}),E(oe)]})})]}),e.jsxs("div",{className:"mt-auto px-6 py-6 md:px-12 md:pb-16 md:pt-12 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20 animate-in slide-in-from-bottom-8 duration-700 shrink-0",children:[e.jsxs("div",{className:"flex items-center justify-between w-full md:w-auto md:gap-24",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:a("Latency")}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter ${t?"text-black":"text-white"}`,children:a("14MS")}),e.jsx("div",{className:"flex gap-1",children:[1,2,3,4,5].map(i=>e.jsx("div",{className:`w-1 h-4 md:h-6 ${i<4?"bg-blue-500":t?"bg-black/20":"bg-white/20"}`},i))})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:a("Memory")}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter ${t?"text-black":"text-white"}`,children:a("1.2GB")}),e.jsx("div",{className:`w-12 md:w-20 h-2 rounded-full overflow-hidden ${t?"bg-black/15":"bg-white/15"}`,children:e.jsx("div",{className:"w-2/3 h-full bg-purple-500"})})]})]})]}),e.jsxs("div",{className:"flex items-center justify-between w-full md:w-auto md:gap-24 text-right",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:a("Sync")}),e.jsxs("div",{className:"flex items-center gap-4 justify-end",children:[e.jsx("span",{className:"text-3xl md:text-5xl font-black text-green-500 tracking-tighter uppercase",children:a("ACTIVE")}),e.jsx(ne,{size:24,className:"text-green-500 animate-pulse"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:`text-[10px] font-black uppercase tracking-[0.5em] ${t?"text-black":"text-white"}`,children:a("Regional Hub")}),e.jsx("span",{className:`text-3xl md:text-5xl font-black tracking-tighter uppercase ${t?"text-black":"text-white"}`,children:a("MX-NORTH")})]})]})]})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                ...
                `}})]})}),document.body)};export{ye as StudioSettingsPortal};
