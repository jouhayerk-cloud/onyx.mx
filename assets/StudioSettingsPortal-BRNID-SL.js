import{j as e}from"./vendor-animation-C_IUUNV4.js";import{bx as S,by as C,ac as A,bz as R,i as z,bA as T,bB as D,bC as P,D as M,r as L,aX as E,O as F}from"./main-BI3k0dSZ.js";import{T as l}from"./themes-assets-iyrvH4b1.js";import{f as o}from"./vendor-react-C0lCFRHy.js";import{X as O,$ as U,aq as $,bk as B,bl as H,_ as V,aV as x,r as q,aw as G,bh as W}from"./vendor-icons-B2C94s-c.js";import"./vendor-pdf-Dfpd9Koy.js";import"./vendor-db-BbqE7tWj.js";import"./vendor-supabase-CHLpTVyu.js";import"./vendor-excel-D91t5TVv.js";const Q=`# Changelog
# 
## [1.80.0] - 2026-04-24
### Added
...
---
`,X=["nacar","aqua"],_=[{name:"talan",swatch:l.talan.swatch},{name:"fluorite",swatch:l.fluorite.swatch},{name:"nacar",swatch:l.nacar.swatch},{name:"aqua",swatch:l.aqua.swatch}],oe=()=>{const[f,b]=o(S),[m,y]=o(C),[g,v]=o(A),[r,w]=o(R),[p]=o(z),[d]=o(T),{goOffline:k,goOnline:j}=D(),N=P(),{t:J}=M();if(!f)return null;const t=X.includes(g),h=()=>b(!1),I=a=>{if(a.trim().length===0)return e.jsxs("div",{className:`flex flex-col items-center justify-center py-20 gap-4 ${t?"text-black/30":"text-white/30"}`,children:[e.jsx(G,{size:40,strokeWidth:1}),e.jsx("p",{className:"text-xs font-black uppercase tracking-[0.2em]",children:"Documentation Offline"})]});const u=a.replace(/<!--[\s\S]*?-->/g,"").trim().split(`
