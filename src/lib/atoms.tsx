...
// Main Views
export const activeViewAtom = atom<'create' | 'inventory' | 'logistics' | 'finance' | 'upload' | 'control'>('inventory');
...
export const inventoryViewModeAtom = atomWithStorage<'grid' | 'list'>('inventoryViewMode', 'grid');
