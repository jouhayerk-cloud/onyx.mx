...
export const PaymentsFilterBar: React.FC = () => {
    ...
    return (
        <div className="flex-none flex flex-col border-b border-white/10 animate-in slide-in-from-top-2 duration-300 bg-black/20 backdrop-blur-3xl z-[90] sticky top-24 sm:top-28">
