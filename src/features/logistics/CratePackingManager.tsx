...
const ActiveCrateHUD: React.FC<{
    ...
    return (
        <div className="sticky top-28 sm:top-32 z-[60] w-full bg-black/60 backdrop-blur-3xl border-b border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
    ...
    return createPortal(
        <div className="fixed inset-0 z-[600] flex flex-col bg-black/60 backdrop-blur-xl select-none animate-in fade-in duration-500">
            ...
            <div className={`flex-1 flex flex-col min-w-0 relative ${!selectedCrate ? 'hidden' : ''}`}>
                ...
                <div className={`sticky top-28 sm:top-32 z-[90] overflow-hidden transition-all duration-700 bg-black/40 backdrop-blur-3xl border-b border-white/10 ${isFiltersOpen ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                    <div className="flex flex-col">
