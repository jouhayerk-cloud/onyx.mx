...
export const PackingModule: React.FC = () => {
    ...
    return (
        <div className="flex-1 flex flex-col relative bg-transparent">
            ...
            <div className={`sticky top-28 sm:top-32 z-[90] overflow-hidden transition-all duration-700 bg-black/40 backdrop-blur-3xl border-b border-white/10 ${isConfigExpanded ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                <div className="flex flex-col">
