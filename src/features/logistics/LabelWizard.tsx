        ...
        <div className="fixed inset-0 z-[5000] flex flex-col pointer-events-none animate-in fade-in duration-700 overflow-hidden">
            ...
            <div className="relative w-full h-[100dvh] md:w-[95vw] md:h-[95vh] flex flex-col overflow-y-auto overflow-x-hidden no-scrollbar pointer-events-auto p-8 md:p-12 lg:p-16 max-w-7xl mx-auto animate-in zoom-in-95 duration-700 bg-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                      ...
                      {/* Bluetooth Print Module (PrintHelper Launcher) */}
                      <div className="flex flex-col items-center gap-6 group">
                          <button 
                              onClick={() => setIsPrintHelperOpen(true)} 
                              disabled={progress.printer > 0 && progress.printer < 100} 
                          ...
                          <div className="flex flex-col items-center gap-1 w-full max-w-[200px]">
                              ...
                              <button 
                                  onClick={() => setIsPrintHelperOpen(true)}
                                  className="mt-4 w-full py-2 bg-(--main-color)/10 hover:bg-(--main-color)/20 border border-(--main-color)/30 text-(--main-color) text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-95"
                              >
                                  CONFIGURE PRINTER
                              </button>
