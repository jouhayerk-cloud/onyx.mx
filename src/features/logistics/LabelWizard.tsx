...
export const LabelWizard: React.FC = () => {
    ...
    const ONYX_MASTER_TEMPLATE_50x50 = (width: number, height: number) => ({
        ...
        elements: [
            ...
            { id: "el_mat", type: "text", zone: 0, x: 130, y: 65, width: 250, height: 30, rotation: 0, align: "left", text: "{{COLOR MATERIAL}}", fontSize: 22, fontFamily: "Inter, sans-serif", fontWeight: "normal", autoScale: true, noWrap: true },
            { id: "el_sizes", type: "text", zone: 0, x: 130, y: 105, width: 250, height: 22, rotation: 0, align: "left", text: "{{SIZES}}", fontSize: 18, fontFamily: "Inter, sans-serif", fontWeight: "bold", autoScale: true, noWrap: true },
